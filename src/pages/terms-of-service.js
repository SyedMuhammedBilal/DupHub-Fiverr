      ...
      <div className="row">
        <div className="col-12 col-md-8">
          ...
          <p className="font-size-lg text-gray-800 mb-6 mb-md-8">
            ...
            goodies, but the bottom line is it’s our aim to always take care of
          ...
          <div className="d-flex">
            ...
            {/* Text */}
            <p className="text-gray-800">
              The Standard License grants you a non-exclusive right to make use
              of Theme you have purchased.
            </p>
          </div>
          <div className="d-flex">
            {/* Badge */}
          ...
          <div className="d-flex">
            ...
            <p className="text-gray-800">
              ...
              adhering to the original license or clearing it with the author of
              the code, image, or content.
            </p>
          </div>
          <div className="d-flex">
            {/* Badge */}
            ...
            <p className="text-gray-800">
              ...
              right to distribute the End Product until the Theme has been fully
          ...
          <div className="d-flex">
            ...
            {/* Text */}
            <p className="text-gray-800">
              The author of the Theme retains ownership of the Theme, but grants
              you the license on these terms. This license is between the author
              of the Theme and you. Be Colossal LLC (Bootstrap Themes) are not a
              party to this license or the one granting you the license.
            </p>
          </div>
          {/* Text */}
          ...
          <div className="d-flex">
            ...
            {/* Text */}
            <p className="text-gray-800">
              You have 14 days to evaluate your purchase. If your purchase fails
              to meet expectations set by the seller, or is critically flawed in
              some way, contact Bootstrap Themes and we will issue a full refund
              pending a review.
            </p>
          </div>
          <div className="d-flex">
