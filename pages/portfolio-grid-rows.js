...
export default function PortfolioRows() {
  return (
    <div>
  <section
  ...
  <section className="py-8 py-md-11 mt-n10 mt-md-n14">
    <div className="container">
      ...
      >
        <div className="col-12 ux">
          {/* Card */}
          <a className="card lift lift-lg shadow-light-lg mb-7" href="#!">
            {/* Image */}
            <img
        ...
        <div className="col-12 col-md-7 product">
          {/* Card */}
          <a className="card lift lift-lg shadow-light-lg mb-7" href="#!">
            {/* Image */}
            <img
        ...
        <div className="col-12 col-md-7 resources">
          {/* Card */}
          <a className="card lift lift-lg shadow-light-lg mb-7" href="#!">
            {/* Image */}
            <img
        ...
        <div className="col-12 col-md-5 resources">
          {/* Card */}
          <a className="card lift lift-lg shadow-light-lg mb-7" href="#!">
            {/* Image */}
            <img
